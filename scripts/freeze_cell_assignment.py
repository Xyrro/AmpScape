...
def main():
    ...
    out = {"seed": int(cfg["seed"]), "band_deg": grid.size_deg, "n_cells_total": len(cells), "n_land_cells": len(land),
           "fractions": fractions, "strata": "dominant RESOLVE realm of the v1.0 S candidate points per cell",
           "source": "data/tiles/v1/specs/S/candidates.parquet (seed 202609061, 60 000 uniform land points)",
           "assignment": assign, "realm": realm}
